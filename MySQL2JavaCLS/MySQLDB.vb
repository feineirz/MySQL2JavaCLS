...
Public Class MySQLDB
  ...
  Public Function getTableInfo(TableName As String) As DataTableInfo
    ...
    Try
      ...
      If rd.HasRows Then
        While rd.Read()
          ...
          dti.ColumnList = ListColumn(dti.TableName)
        End While
      End If
  ...
  Public Function ListTables() As List(Of DataTableInfo)
  ...
  Public Function ListColumn(TableName As String) As List(Of DataColumnInfo)
